...
public class GridLayoutActivity extends AppCompatActivity {
    ...
    private void initView() {
        mLayoutManager = new GridLayoutManager(GridLayoutActivity.this, 3, GridLayoutManager.VERTICAL, false);
    ...
    private void initListener() {
        ...
        mItemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                viewHolder.itemView.setAlpha(1 - Math.abs(dX) / ScreenUtils.getScreenWidth(GridLayoutActivity.this));
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> implements View.OnClickListener {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(GridLayoutActivity.this).inflate(R.layout.item_activity_grid, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            Glide.with(GridLayoutActivity.this).load(mMeiziList.get(position).getUrl()).into(holder.imageView);
        }
