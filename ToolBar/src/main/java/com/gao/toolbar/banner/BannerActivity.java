 ...
 */
public class BannerActivity extends Activity implements BGABanner.OnItemClickListener, BGABanner.Adapter {
    ...
    private void setListener() {
        mDefaultBanner.setOnItemClickListener(BannerActivity.this);
        mCubeBanner.setOnItemClickListener(BannerActivity.this);
    }
